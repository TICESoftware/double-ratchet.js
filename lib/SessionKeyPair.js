...
exports.Side = exports.sessionKeyPair = void 0;
...
function sessionKeyPair(publicKey, secretKey, otherPublicKey, side) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (side == Side.receiving) {
            return (0, libsodium_wrappers_1.crypto_kx_client_session_keys)(publicKey, secretKey, otherPublicKey);
        }
        else {
            return (0, libsodium_wrappers_1.crypto_kx_server_session_keys)(publicKey, secretKey, otherPublicKey);
        }
    });
}

...
function setUp(maxSkip, maxCache) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sharedSecret = (0, libsodium_wrappers_1.from_hex)('00112233445566778899AABBCCDDEEFF00112233445566778899AABBCCDDEEFF');
...
test('encodeHeaderBytes', () => __awaiter(void 0, void 0, void 0, function* () {
    yield libsodium_wrappers_1.ready;
    const pubKey = (0, libsodium_wrappers_1.from_hex)("0efd0d78c9ba26b39588848ddf69b02807fb85916c2b004d7af759f932544443");
    ...
    const header = new _1.Header(pubKey, 1234567890, 9876543210);
    expect((0, libsodium_wrappers_1.to_hex)(header.bytes)).toEqual(headerBytesShouldBe);
}));

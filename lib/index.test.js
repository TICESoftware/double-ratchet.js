...
test('encodeHeaderBytes', () => __awaiter(void 0, void 0, void 0, function* () {
    yield libsodium_wrappers_1.ready;
    const pubKey = libsodium_wrappers_1.from_hex("0efd0d78c9ba26b39588848ddf69b02807fb85916c2b004d7af759f932544443");
    ...
    expect(libsodium_wrappers_1.to_hex(header.bytes)).toEqual(headerBytesShouldBe);
}));

...
class MessageChain {
    ...
    nextMessageKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const messageKey = (0, libsodium_wrappers_1.crypto_auth)(this.messageKeyInput, this.chainKey);
            const newChainKey = (0, libsodium_wrappers_1.crypto_auth)(this.chainKeyInput, this.chainKey);

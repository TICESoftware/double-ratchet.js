...
class DoubleRatchet {
    ...
    static init(info, maxCache, maxSkip, sharedSecret, remotePublicKey, keyPair) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (keyPair) {
                ...
                rootKeyPair = (0, libsodium_wrappers_1.crypto_kx_keypair)();
            }
    ...
    doubleRatchetStep(publicKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield libsodium_wrappers_1.ready;
            this.rootChain.keyPair = (0, libsodium_wrappers_1.crypto_kx_keypair)();
...
function crypto_aead_xchacha20poly1305_ietf_encrypt_with_nonce(message, secretKey, additionalData) {
    const nonce = (0, libsodium_wrappers_1.randombytes_buf)(libsodium_wrappers_1.crypto_aead_xchacha20poly1305_ietf_NPUBBYTES);
    const cipher = (0, libsodium_wrappers_1.crypto_aead_xchacha20poly1305_ietf_encrypt)(message, additionalData ? additionalData : null, null, nonce, secretKey);
...
function crypto_aead_xchacha20poly1305_ietf_decrypt_with_nonce(nonceAndCipher, secretKey, additionalData) {
    ...
    const plaintext = (0, libsodium_wrappers_1.crypto_aead_xchacha20poly1305_ietf_decrypt)(null, ciphertext, additionalData ? additionalData : null, nonce, secretKey);
    return plaintext;
}
